...
UserTeam::UserTeam()
{
    map_init(playNames)(RUN, "Run")(SHORT_PASS, "Short pass")(LONG_PASS, "Long pass")(PUNT, "Punt")(FIELD_GOAL, "Field goal");

    map_init(downs)(FIRST, "First down")(SECOND, "Second down")(THIRD, "Third down")(FOURTH, "Fourth down");
}
